...
class TestMovieDataExtraction(unittest.TestCase):
    ...
    def test_extract_duration_period(self):
        ...
        self.assertEqual(extract_duration_period('Top Gun 2PG-132\xa0h 10\xa0min.Acțiune'), ('2', '10'))
        self.assertEqual(extract_duration_period('Decizia de a plecaNot Rated (USA)2\xa0h 18\xa0min.De comedie'), ('2', '18'))
        self.assertEqual(extract_duration_period('Unknown MovieG1\xa0h 30\xa0min.Dramă'), ('1', '30'))
        self.assertEqual(extract_duration_period('Short MovieR1\xa0oreAcțiune'), ('1', '0'))
        self.assertIsNone(extract_duration_period('Movie with no duration.Acțiune'))
